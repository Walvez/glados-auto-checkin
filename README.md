...
每天自动完成签到，及时通知结果<br>
支持 **ScriptCat · Surge · Quantumult X**，兼容 6 个 GLaDOS 主站域名：`glados.network`、`glados.rocks`、`glados.one`、`glados.space`、`glados.cloud`、`glados.vip`
...
测试覆盖全部 6 个主站域名、Surge / Quantumult X 运行时、已签到响应、无效 JSON、401/403、429 重试、5xx 部分成功、当日跳过、配置文件 hostname/正则、固定更新地址和通知边界。
